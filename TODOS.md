...
- [ ] **25c.** Resolve `TODO(verify)` flags: (1) survey-pool automatic metrics in `tab:rq2-automatic` and the discussion scale-dependence paragraph predate the 2026-05-05 single-call -> 3-step-pipeline switch (22f); re-derive from runs aea60b3d / 460d4b15 / 10366af9 so the table describes the systems the survey actually rated; (2) confirm pool N (28 vs 30) for those numbers.
